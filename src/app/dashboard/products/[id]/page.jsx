    ...
    return (
        <main>
            <div id='gradient' className="h-screen w-screen min-w-96 flex justify-center items-center">
                ...
                <div className="w-2/3 min-w-[280px] h-fit lg:h-[60%] flex flex-col lg:flex-row items-center lg:items-start rounded-lg shadow-xl gap-8 border border-gray-400 mt-52 md:mt-72 lg:mt-10 pb-10 lg:pb-0">
                    <div className="w-full lg:w-1/2 h-full flex justify-center items-center p-10 bg-white rounded-lg">
                        <Image src={product.image}  width={450} height={500} className="w-3/4 h-full object-contain rounded-lg" alt={product.title}></Image>
                    </div>
                    <div className="w-full lg:w-1/2 h-full flex flex-col lg:justify-start gap-10 mt-10 bg-transparent px-5">
                        <h1 className="text-lg lg:text-2xl font-bold line-clamp-1">{product.title}</h1>
